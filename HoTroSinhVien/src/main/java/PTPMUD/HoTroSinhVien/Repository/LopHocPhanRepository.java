...
public interface LopHocPhanRepository extends JpaRepository<LopHocPhan,Integer> {
    ...
    int countByMonHoc_MaMon(String maMon);
    ...
    boolean existsByNgayBatDauAfterAndMonHoc_MaMon(LocalDate ngay, String maMon);
    boolean existsByMonHoc_TenMonHoc(String tenMonHoc);
}
